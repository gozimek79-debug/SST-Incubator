"""CLOS Control Center v0.7.3."""

import argparse, sys
from .commands import route_command

def main():
    parser = argparse.ArgumentParser(description="CLOS Control Center v0.7.3")
    ...
    p_demo.add_argument("--telemetry", type=int, default=0, help="Zapisuj snapshot co N tickow (0=wylaczone)")
