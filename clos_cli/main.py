...
def main():
    parser = argparse.ArgumentParser(description="CLOS Control Center")
    ...
    else: route_command(args.command, getattr(args, "seed", 42), getattr(args, "ticks", 200), stream_mode, genome=genome_val)
