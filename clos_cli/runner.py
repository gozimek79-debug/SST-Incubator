"""CLI Runner v0.7 – z komendą school."""
...
def run_school():
    ...
    print("=" * 60)
    print("CLOS Cognitive Research Curriculum v0.7")
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        json.dump({
            "level": 0, "level_passed": level_passed, "exam_passed": exam_passed,
            "passed_lessons": passed_lessons, "total_lessons": total_lessons,
            "results": {k: {kk: vv for kk, vv in v.items() if kk != "runs"} for k, v in results.items()},
