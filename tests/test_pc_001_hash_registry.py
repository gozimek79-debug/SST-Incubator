...
Ten plik dowodzi:
1. Wszystkie 43 pliki z CRITICAL_FILES_PC_001 (26 + Aneks 2: T7/K7 + B3: kod
   ...
   docs/GOVERNANCE_RULES.md, 2026-07-28) istnieja i sa czytelne.
...
class TestCriticalFilesPC001Exist:
    ...
    def test_all_43_files_exist(self):
        assert len(CRITICAL_FILES_PC_001) == 43
